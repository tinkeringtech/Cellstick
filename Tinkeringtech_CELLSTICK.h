...
//#define Tinkeringtech_CELLSTICK_DEBUG

#define CELLSTICK_HEADSETAUDIO 0
#define CELLSTICK_EXTAUDIO 1

#define CELLSTICK_STTONE_DIALTONE 1
#define CELLSTICK_STTONE_BUSY 2
#define CELLSTICK_STTONE_CONGESTION 3
#define CELLSTICK_STTONE_PATHACK 4
#define CELLSTICK_STTONE_DROPPED 5
#define CELLSTICK_STTONE_ERROR 6
#define CELLSTICK_STTONE_CALLWAIT 7
#define CELLSTICK_STTONE_RINGING 8
#define CELLSTICK_STTONE_BEEP 16
#define CELLSTICK_STTONE_POSTONE 17
#define CELLSTICK_STTONE_ERRTONE 18
#define CELLSTICK_STTONE_INDIANDIALTONE 19
#define CELLSTICK_STTONE_USADIALTONE 20

#define CELLSTICK_DEFAULT_TIMEOUT_MS 500

class Tinkeringtech_CELLSTICK : public Stream {
 public:
#if ARDUINO >= 100
  Tinkeringtech_CELLSTICK(SoftwareSerial *, int8_t r);
#else
  Tinkeringtech_CELLSTICK(NewSoftSerial *, int8_t r);
#endif
  ...
  boolean FMradio(boolean onoff, uint8_t a = CELLSTICK_HEADSETAUDIO);
 ...
 private:
  ...
  uint8_t readline(uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS, boolean multiline = false);
  uint8_t getReply(char *send, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  uint8_t getReply(const __FlashStringHelper *send, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  uint8_t getReply(const __FlashStringHelper *prefix, char *suffix, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  uint8_t getReply(const __FlashStringHelper *prefix, int32_t suffix, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  ...
  uint8_t getReplyQuoted(const __FlashStringHelper *prefix, const __FlashStringHelper *suffix, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);

  boolean sendCheckReply(char *send, char *reply, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  boolean sendCheckReply(const __FlashStringHelper *send, const __FlashStringHelper *reply, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  boolean sendCheckReply(const __FlashStringHelper *prefix, char *suffix, const __FlashStringHelper *reply, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  boolean sendCheckReply(const __FlashStringHelper *prefix, int32_t suffix, const __FlashStringHelper *reply, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  boolean sendCheckReply(const __FlashStringHelper *prefix, int32_t suffix, int32_t suffix2, const __FlashStringHelper *reply, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
  boolean sendCheckReplyQuoted(const __FlashStringHelper *prefix, const __FlashStringHelper *suffix, const __FlashStringHelper *reply, uint16_t timeout = CELLSTICK_DEFAULT_TIMEOUT_MS);
